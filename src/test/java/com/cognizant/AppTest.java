...
public class AppTest {
	...
	public void test1() {
		...
		try {
			operationClass = Class.forName("com.cognizant.javaapp301.operation.ArmstrongNumber");
	...
	public void test2() {
		...
		try {
			...
			String expectedMethodSyntax = "public java.lang.String com.cognizant.javaapp301.operation.ArmstrongNumber.defineArmstrongNumber()";
	...
	public void test3() {
		...
		try {
			operationMethod = operationClass.getMethod("verifyArmstrongNumber", Integer.TYPE);
			
			String expectedMethodSyntax = "public java.lang.String com.cognizant.javaapp301.operation.ArmstrongNumber.verifyArmstrongNumber(int)";
			String actualMethodSyntax = operationMethod.toString();
